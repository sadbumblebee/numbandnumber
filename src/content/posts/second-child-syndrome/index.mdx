...
<Ai2html slug="second-child-syndrome" name="photo_chart" description="This line chart shows number of photos captured in the Y-Axis of my first kid over 180 days (in the X-Axis). The line shows a steady increase to 703 photos of Kid 1." assetsPathOverride="/posts/second-child-syndrome/ai2html-output" />

Here are the total photos I took of my daughter, six months since her birth … Just over 700 photos.

<Ai2html slug="second-child-syndrome" name="photo_chart_2" description="This second line chart adds an additional line here that shows the amount of photos taken of my second child over adjusted to the same time period. In this line, we see that a total of 370 photos were taken." assetsPathOverride="/posts/second-child-syndrome/ai2html-output" />
...
<Ai2html slug="second-child-syndrome" name="feeding_scatter" description="This scatterplot shows in the Y-Axis time in a 24-hour day. Over 90 days, the data set are breast versus bottle feedings. This is representative of how much data was collected over the feeding of our kid. It's demonstrative of the abundance of data." assetsPathOverride="/posts/second-child-syndrome/ai2html-output" />
